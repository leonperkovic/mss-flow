...
public class RentSpaceshipDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        execution.setVariable(ProcessVariables.RENTED_SHIP_ID, rentedSpaceship.getId());
        execution.setVariable(ProcessVariables.SHIP_CARGO_LIMIT, rentedSpaceship.getCargoLimit());
    }
}
